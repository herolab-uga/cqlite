...
#include <vector>
#include "stdint.h"
#include "cqlite_functions.h"
#include "cqlite_mtrand.h"
...
// generate the same numbers as in the original C test program
  ros::init(argc, argv, "global_frontier_detector");
  ros::NodeHandle nh;
  ...
  ros::param::param<std::string>(ns+"/map_topic", map_topic, "/tb3_1/map"); 
//---------------------------------------------------------------
